...
# address = os.path.join(base_dir, 'results/TUM/2022_09_18_16_26_33')
...
train_params = {
    ...
    'loss': {
        ...
        'w':  1e6,
        'target': 'rotation matrix mask', # rotation matrix, rotation matrix mask
        'huber': 0.005,
        'dt': 0.005,
    },
